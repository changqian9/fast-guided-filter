...
enum SmoothMoreMethod_c { CV_FASTGUIDED = CV_BILATERAL << 3 };
...
static av_cold int smooth_init(AVFilterContext *ctx, const char *args)
{
    ...
    else if (!strcmp(type_str, "fastguided"   )) smooth->type = CV_FASTGUIDED;
    else {
    ...
    } else if (smooth->param1 < 0 || !(smooth->param1%2)) {
...
static const OCVFilterEntry ocv_filter_entries[] = {
    ...
    { "fastguided", sizeof(SmoothContext), smooth_init, NULL, smooth_end_frame_filter },
};
